<script>
    ...
    function speak(text) {
        ...
        const url = `${API_BASE}/chat/tts?text=${encodeURIComponent(cleanText)}`;
    ...
    <div class="fixed inset-0 z-50 pointer-events-none">
        ...
        >
            ...
            <div class="flex flex-1 overflow-hidden">
                ...
                >
                    <div class="p-1.5 border-b border-fd-border">
                        <button
                            onclick={createNewChat}
                            class="w-full px-2 py-1.5 text-[10px] font-bold bg-fd-primary/10 hover:bg-fd-primary/20 text-fd-primary rounded-lg transition-all flex items-center justify-center gap-1.5"
                        >
                ...
                <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div
                        ...
                        class="flex-1 overflow-y-auto p-3 flex flex-col gap-2 custom-scrollbar bg-fd-background/20"
                    >
                        {#each messages as msg, i}
                            ...
                            >
                                ...
                                <div class="max-w-[85%] group">
                                    <div
                                        class="px-2.5 py-1.5 rounded-lg text-[11px] leading-snug border {msg.role ===
                                        'user'
                                    ...
                                    {#if msg.role === "model"}
                                        ...
                                        >
                                            <button
                                                onclick={() =>
                                                    speak(msg.content)}
                                                class="px-2 py-0.5 rounded bg-fd-secondary hover:bg-fd-accent text-[9px] font-bold text-fd-muted hover:text-fd-primary transition-all flex items-center gap-1"
                                                title="Nghe"
                                            >
                                                <i
                                                    class="bx bx-volume-full text-xs"
                                                ></i>
                                                {currentAudio &&
                                                !currentAudio.paused
                                                    ? "Đang nói..."
                                            ...
                                            {#if currentAudio && !currentAudio.paused}
                                                <button
                                                    onclick={stopAudio}
                                                    class="px-2 py-0.5 rounded bg-fd-secondary hover:bg-fd-accent text-[9px] font-bold text-red-500 hover:text-red-600 transition-all flex items-center gap-1"
                                                    title="Dừng"
                                                >
                                                    <i
                                                        class="bx bx-stop-circle text-xs"
                                                    ></i>
                                                    Dừng
                                                </button>
                                            {/if}
